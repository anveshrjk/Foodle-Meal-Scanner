    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 dark:from-primary/10 dark:via-primary/20 dark:to-primary/10 flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Welcome back, food detective! 🕵️</p>
        </div>

        <Card className="border-primary/20 shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-foreground">Ready to Scan Some Food?</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {isLoading ? "Signing in..." : "Sign In & Start Scanning! 🚀"}
              </Button>
            </form>
            ...
            <div className="mt-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full mt-4 border-primary/20 hover:bg-primary/5 bg-transparent"
